...
export default function SellerNotificationBell({ sellerId }: { sellerId: string }) {
  const router = useRouter();
  const [showDropdown, setShowDropdown] = useState(false);
  const { notifications, unreadCount, isConnected, markAsRead, markAllAsRead } = useNotifications(sellerId, 'seller');
