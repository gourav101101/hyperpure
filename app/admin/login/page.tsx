...
export default function AdminLogin() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (email === "admin@hyperpure.com" && password === "admin123") {
      ...
      alert("Invalid credentials! Use: admin@hyperpure.com / admin123");
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center px-6">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">Login to manage Hyperpure</p>
          <div className="mt-3 text-xs text-gray-400 bg-gray-50 p-2 rounded">
            Demo: admin@hyperpure.com / admin123
          </div>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="admin@hyperpure.com"
              required
            />
          </div>
